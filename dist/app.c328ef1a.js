...
function upload(selector) {
  ...
  var upload = element('button', ['btn', 'primary'], 'Load');
  ...
  var clearPreviewInfo = function clearPreviewInfo(el) {
    el.style.opacity = '1';
  ...
  var uploadHandler = function uploadHandler() {
    ...
    onUpload(files);
    setTimeout(function () {
      return preview.querySelectorAll('.preview-image').forEach(function (e) {
        return e.remove();
      });
    }, 2000);
    setTimeout(function () {
      return upload.style.display = 'none';
    }, 2000);
  };
